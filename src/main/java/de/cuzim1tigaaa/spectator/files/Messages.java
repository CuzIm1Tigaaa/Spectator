...
public final class Messages {
    ...
    public static void loadMessages(SpectatorPlugin plugin) {
        ...
        try {
            ...
            set(Paths.MESSAGES_GENERAL_CYCLEONLY, "&cYou can only use &7/SpectateCycle start <Interval>");
            ...
            set(Paths.MESSAGES_COMMANDS_SPECTATE_JOIN_OTHER, "&e%TARGET% &7is no longer in Spectator-Mode.");
            set(Paths.MESSAGES_COMMANDS_SPECTATE_LEAVE_OTHER, "&e%TARGET% &7is now in Spectator-Mode.");
