...
public final class Paths {
    ...
    public static final String CONFIG_CYCLE_KICK_PLAYERS =                  "Settings.Cycle.KickCyclingPlayers";
    ...
    public static final String MESSAGES_GENERAL_BYPASS_TELEPORT =           "Messages.General.BypassTeleport";
    public static final String MESSAGES_GENERAL_BYPASS_INVENTORY =          "Messages.General.BypassInventory";
    ...
    public static final String MESSAGES_GENERAL_NOTIFY_SPECTATE =           "Messages.General.Notify.Spectate";
    public static final String MESSAGES_GENERAL_NOTIFY_UNSPECTATE =         "Messages.General.Notify.Unspectate";

    public static final String MESSAGES_CYCLING_CURRENT_TARGET =            "Messages.Cycling.CurrentTarget";
    public static final String MESSAGES_CYCLING_SEARCHING_TARGET =          "Messages.Cycling.SearchingTarget";
