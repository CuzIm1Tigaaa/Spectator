...
public class Config {
    ...
    public static void loadConfig(Spectator plugin) {
        ...
        try {
            ...
            set(CONFIG_NOTIFY_UPDATE, comments(true,
            ...
            set(CONFIG_HIDE_PLAYERS_TAB, comments(true,
            ...
            set(CONFIG_SAVE_PLAYERS_FLIGHTMODE, comments(true,
            ...
            set(CONFIG_INVENTORY_CONTAINERS, comments(true,
            ...
            set(CONFIG_INVENTORY_ENDERCHEST, comments(true,
            ...
            set(CONFIG_SHOW_BOSS_BAR, comments(true,
                    "Shows a bossbar to cycling players with the name of the current target"), false);

            config.save(configFile);
        }catch(IOException exception) { exception.printStackTrace(); }
        if(config.getInt(CONFIG_VERSION) < currentVersion) replaceConfig(plugin, false);
    }
